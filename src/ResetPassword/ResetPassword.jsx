...
export default function ResetPassword() {
    ...
    async function resetPassword(value)
    {
        ...
        let req= await axios.put("https://ecommerce.routemisr.com/api/v1/auth/resetPassword",value).catch((err)=>{
 ...
 return <>
  <div className="container me-5">
    ...
    {loading?<button disabled={!(Formik2.dirty && Formik2.isValid)} className=' btn  main-bg text-white mt-4' type="submit">Login</button>
